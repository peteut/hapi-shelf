...
//internals.preHandler = function (bookshelf, settings, request, reply) {
    //var config = Hoek.reach(request,
        //'request.route.settings.plugins.bookshelf');
//};
...
exports.register = function (server, options, next) {
    ...
    //server.ext('onPreHandler',
        //R.bind(internals.preHandler, internals)(Bookshelf));
    next();
};
